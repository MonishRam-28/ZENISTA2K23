...
import React from 'react'
import './footer.css'
import logo from '../images/logo_edited-removebg-preview.png';
...
const Accordion = () => {
  return (
    ...
    <div className='footer-grid-container'>
      ...
      <a className='link-href' href="https://instagram.com/zenista2k23?igshid=MmU2YjMzNjRlOQ==" target="_blank">
